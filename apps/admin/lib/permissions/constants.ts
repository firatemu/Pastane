...
export const NAV_ITEMS: readonly Nav[] = [
  ...
  { label: 'Alerjenler', href: '/allergens', permissions: ['allergens.view', 'permissions.manage'], enabled: true, group: 'Katalog' },
  { label: 'Stok', href: '/stock', permissions: ['stock.view'], enabled: true, group: 'Katalog' },
