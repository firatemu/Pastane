    ...
    <aside className="sticky top-28 h-fit rounded-3xl bg-primary p-6 text-white shadow-ambient">
      ...
      <dl className="mt-8 space-y-4 text-sm">
        <div className="flex justify-between border-b border-white/15 pb-4">
          <dt>Sepet ara toplamı</dt>
          <dd className="font-semibold">{formatTry(cartEstimate(cart))}</dd>
        </div>
      </dl>
      <p className="mt-5 text-xs leading-5 text-white/65">
        Kesin toplam, stok ve teslimat ücreti ödeme adımında sunucu tarafından yeniden hesaplanır.
      </p>
      <a
